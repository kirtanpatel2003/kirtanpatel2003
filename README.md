...
<p align="left"> <a href="https://github.com/ryo-ma/github-profile-trophy"><img src="https://github-profile-trophy.vercel.app/?username=kirtanpatel2003" alt="kirtanpatel2003" /></a> </p>
...
<path d="M7249 1054 c-42 -7 -109 -25 -150 -40 -76 -27 -226 -101 -267 -133 l-24 -18 41 -66 c22 -37 36 -67 31 -67 -18 0 -11 -80 11 -121 11 -22 53 -73 92 -113 279 -282 682 -361 1251 -245 113 23 172 49 188 84 14 30 3 72 -20 77 -9 3 18 15 61 29 l78 24 -93 81 c-362 313 -622 460 -902 509 -106 18 -194 18 -297 -1z"/>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="68" y="35" width="65" height="65" viewBox="0 0 30 30" fill="#B0B0B0">
  ...
  <defs>
    ...
    <stop offset="100%" stop-color="#9090C0"/>
    
    </linearGradient>
  </defs>
  <svg xmlns="http://www.w3.org/2000/svg" x="28" y="20" width="100" height="100" viewBox="0 0 30 30" fill="url(#AA)">
    ...
    <text x="6" y="8" font-family="Courier, Monospace" font-size="7" fill="#505050">A</text>
          ...
          <text x="50%" y="97" text-anchor="middle" font-family="Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji" font-weight="bold" font-size="10" fill="#666">213pt</text>
    ...
    <rect id="Commits-rank-progress" x="15" y="101" rx="1" height="3.2" fill="#0366d6"/>
  
        </svg>
        
        <svg xmlns="http://www.w3.org/2000/svg" x="110" y="0" width="110" height="110" viewBox="0 0 110 110" fill="none">
          <rect x="0.5" y="0.5" rx="4.5" width="109" height="109" stroke="#e1e4e8" fill="#FFF" stroke-opacity="1" fill-opacity="1"/>
  ...
  <defs>
    ...
    <stop offset="0%" stop-color="#A18D66"/>
    <stop offset="70%" stop-color="#A18D66"/>
    <stop offset="100%" stop-color="#816D96"/>
    
    </linearGradient>
  </defs>
  <svg xmlns="http://www.w3.org/2000/svg" x="28" y="20" width="100" height="100" viewBox="0 0 30 30" fill="url(#B)">
    ...
    <path d="M3 1h10c-.495 3.467-.5 10-5 10S3.495 4.467 3 1zm0 15a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1H3zm2-1a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1H5z"/>
    <circle cx="8" cy="6" r="4" fill="#FFF"/>
    <text x="6" y="8" font-family="Courier, Monospace" font-size="7" fill="#412D06">B</text>
          ...
          <text x="50%" y="85" text-anchor="middle" font-family="Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji" font-weight="bold" font-size="10.5" fill="#666">Junior Dev</text>
          <text x="50%" y="97" text-anchor="middle" font-family="Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji" font-weight="bold" font-size="10" fill="#666">9pt</text>
    ...
    <rect x="15" y="101" rx="1" width="80" height="3.2" opacity="0.3" fill="#0366d6"/>
    <rect id="Experience-rank-progress" x="15" y="101" rx="1" height="3.2" fill="#0366d6"/>
  
        </svg>
        
        <svg xmlns="http://www.w3.org/2000/svg" x="220" y="0" width="110" height="110" viewBox="0 0 110 110" fill="none">
          <rect x="0.5" y="0.5" rx="4.5" width="109" height="109" stroke="#e1e4e8" fill="#FFF" stroke-opacity="1" fill-opacity="1"/>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="28" y="20" width="100" height="100" viewBox="0 0 30 30" fill="url(#C)">
    ...
    <path d="M3 1h10c-.495 3.467-.5 10-5 10S3.495 4.467 3 1zm0 15a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1H3zm2-1a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1H5z"/>
    <circle cx="8" cy="6" r="4" fill="#FFF"/>
    <text x="6" y="8" font-family="Courier, Monospace" font-size="7" fill="#333">C</text>
          ...
          <text x="50%" y="85" text-anchor="middle" font-family="Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji" font-weight="bold" font-size="10.5" fill="#666">First Pull</text>
          <text x="50%" y="97" text-anchor="middle" font-family="Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji" font-weight="bold" font-size="10" fill="#666">1pt</text>
    ...
    <rect x="15" y="101" rx="1" width="80" height="3.2" opacity="0.3" fill="#0366d6"/>
    <rect id="PullRequest-rank-progress" x="15" y="101" rx="1" height="3.2" fill="#0366d6"/>
  
        </svg>
        
        <svg xmlns="http://www.w3.org/2000/svg" x="330" y="0" width="110" height="110" viewBox="0 0 110 110" fill="none">
          <rect x="0.5" y="0.5" rx="4.5" width="109" height="109" stroke="#e1e4e8" fill="#FFF" stroke-opacity="1" fill-opacity="1"/>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="28" y="20" width="100" height="100" viewBox="0 0 30 30" fill="url(#C)">
    ...
    <text x="6" y="8" font-family="Courier, Monospace" font-size="7" fill="#333">C</text>
          ...
          <text x="50%" y="85" text-anchor="middle" font-family="Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji" font-weight="bold" font-size="10.5" fill="#666">First Repository</text>
          <text x="50%" y="97" text-anchor="middle" font-family="Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji" font-weight="bold" font-size="10" fill="#666">5pt</text>
    ...
    <rect x="15" y="101" rx="1" width="80" height="3.2" opacity="0.3" fill="#0366d6"/>
    <rect id="Repositories-rank-progress" x="15" y="101" rx="1" height="3.2" fill="#0366d6"/>
  
        </svg>
        
        <svg xmlns="http://www.w3.org/2000/svg" x="440" y="0" width="110" height="110" viewBox="0 0 110 110" fill="none">
          <rect x="0.5" y="0.5" rx="4.5" width="109" height="109" stroke="#e1e4e8" fill="#FFF" stroke-opacity="1" fill-opacity="1"/>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="28" y="20" width="100" height="100" viewBox="0 0 30 30" fill="url(#?)">
    ...
    <rect x="15" y="101" rx="1" width="80" height="3.2" opacity="0.3" fill="#0366d6"/>
    <rect id="Stars-rank-progress" x="15" y="101" rx="1" height="3.2" fill="#0366d6"/>
  
        </svg>
        
        <svg xmlns="http://www.w3.org/2000/svg" x="550" y="0" width="110" height="110" viewBox="0 0 110 110" fill="none">
          <rect x="0.5" y="0.5" rx="4.5" width="109" height="109" stroke="#e1e4e8" fill="#FFF" stroke-opacity="1" fill-opacity="1"/>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="28" y="20" width="100" height="100" viewBox="0 0 30 30" fill="url(#?)">
    ...
    <rect x="15" y="101" rx="1" width="80" height="3.2" opacity="0.3" fill="#0366d6"/>
    <rect id="Followers-rank-progress" x="15" y="101" rx="1" height="3.2" fill="#0366d6"/>
  
        </svg>
        
        <svg xmlns="http://www.w3.org/2000/svg" x="660" y="0" width="110" height="110" viewBox="0 0 110 110" fill="none">
          <rect x="0.5" y="0.5" rx="4.5" width="109" height="109" stroke="#e1e4e8" fill="#FFF" stroke-opacity="1" fill-opacity="1"/>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="28" y="20" width="100" height="100" viewBox="0 0 30 30" fill="url(#?)">
    ...
    <rect x="15" y="101" rx="1" width="80" height="3.2" opacity="0.3" fill="#0366d6"/>
    <rect id="Issues-rank-progress" x="15" y="101" rx="1" height="3.2" fill="#0366d6"/>
  
        </svg>
        
        <svg xmlns="http://www.w3.org/2000/svg" x="770" y="0" width="110" height="110" viewBox="0 0 110 110" fill="none">
          <rect x="0.5" y="0.5" rx="4.5" width="109" height="109" stroke="#e1e4e8" fill="#FFF" stroke-opacity="1" fill-opacity="1"/>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" x="28" y="20" width="100" height="100" viewBox="0 0 30 30" fill="url(#?)">
    ...
    <rect x="15" y="101" rx="1" width="80" height="3.2" opacity="0.3" fill="#0366d6"/>
    <rect id="Reviews-rank-progress" x="15" y="101" rx="1" height="3.2" fill="#0366d6"/>
...
<p><img align="center" src="https://github-readme-streak-stats.herokuapp.com/?user=kirtanpatel2003&" alt="kirtanpatel2003" /></p>
